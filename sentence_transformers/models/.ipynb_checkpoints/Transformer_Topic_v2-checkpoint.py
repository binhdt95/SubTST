...
class Transformer_Topic_v2(nn.Module):
    ...
    def align_attention(self, mat1, mat2):
        align_weights = torch.matmul(torch.transpose(mat1, 1, 2), mat2)
        topic_align_context = torch.matmul(mat2, torch.transpose(align_weights, 1, 2))
        return mat1 + topic_align_context
...
#         output_tokens = torch.cat((output_tokens, token_topic_embeds),2)
        ...
        output_tokens = self.align_attention(output_tokens, token_topic_embeds)
